<template>
  <div class="vue-root-container">
      ...
      <div class="container header">
        ...
        <ul class="nav navbar-nav pull-xs-right">
          ...
          <li v-if="userStore.userInfo?._id" class="nav-item">
            <router-link
              class="nav-link"
              :to="{ name: 'Profile', params: { userId: userInfo?._id } }"
            >
              <img
                style="width: 26px"
                class="user-pic"
    ...
    <footer>
      <div class="container">
        <a href="/" class="logo-font" style="color: rgb(5, 109, 232) !important"
          >知乎</a
        >
        <span class="attribution" style="fontweight: 600">
          这是一个 Koa2 + Nuxt3 学习项目
          <a
            href="https://thinkster.io"
            style="color: rgb(5, 109, 232) !important"
            >GitHub: Neekky</a
